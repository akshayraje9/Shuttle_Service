    ...
    <link href="Style/StyleSheet1.css" rel="stylesheet"  />
     ...
     <script type="text/javascript" >
        ...
        <div style="margin-left:15px; padding-top:1px">
            ...
            <div style="margin-left:15px; clear:both; overflow:hidden">
        ...
        <div style="margin-left:15px; margin-bottom:25px;" >
            ...
            &nbsp&nbsp<asp:Button ID="btnValidate" runat="server" Text="Save Changes" OnClick="btnValidate_Click" CausesValidation="true"  ValidationGroup="usrValid" OnClientClick="return validate()"/>
        </div>
